...
from embodiedscan.models.losses.occ_loss import occ_multiscale_supervision, geo_scal_loss, sem_scal_loss
from mmcv.cnn import build_conv_layer, build_norm_layer, build_upsample_layer
from mmengine.model import BaseModule, constant_init
from embodiedscan.utils.typing_config import SampleList

@MODELS.register_module()
class SurroundOccHead(BaseModule): 
    def __init__(self,
                 *args,
                 ...
                 use_semantic=True,
                 **kwargs):
        super(SurroundOccHead, self).__init__()
    ...
    def _init_layers(self):
        ...
        for i in range(self.fpn_level):
            ...
            transformer_i = MODELS.build(transformer)
    ...
    def predict(self, 
        ...
        pred = self.forward(x, batch_input_metas)['occ_preds'][-1]
        if self.use_semantic:
    ...
    def loss(self,
        ...
        batch_input_metas = [data_samples.metainfo for data_samples in batch_data_samples]
        preds_dicts = self.forward(x, batch_input_metas)
        ground_truth = [data_samples.gt_occupancy for data_samples in batch_data_samples]        # B * N * 4, xyz+label
        ...
        if not self.use_semantic:
            ...
            for i in range(len(preds_dicts['occ_preds'])):
                ...
                gt = occ_multiscale_supervision(ground_truth, ratio, preds_dicts['occ_preds'][i].shape)
